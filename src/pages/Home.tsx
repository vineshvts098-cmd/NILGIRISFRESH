...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      icon: Truck,
      title: 'Free Delivery',
      description: 'Complimentary delivery across India - no minimum order',
    },
  ];
          ...
          <div className="min-h-[90vh] md:min-h-screen flex flex-col justify-center py-16 md:py-20">
            <div className="max-w-2xl">
              ...
              >
                ...
                <p className="text-lg md:text-xl text-primary-foreground/90 mb-6 leading-relaxed max-w-lg">
                ...
                {/* Free Delivery Badge */}
                <div className="inline-flex items-center gap-2 bg-green-500 text-white px-4 py-2 rounded-full shadow-lg mb-8">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="font-semibold">Free Delivery Across India</span>
                </div>
              </motion.div>
